...
```js
var connection = mysql.createConnection("mysql://192.168.1.2/test?flags=-FOUND_ROWS");
```
...
For example, if you have an installation of mysql running on 192.168.1.2:3306
and no password set for the `root` user, run:

```sh
$ mysql -u root -e "CREATE DATABASE IF NOT EXISTS node_mysql_test"
$ MYSQL_HOST=192.168.1.2 MYSQL_PORT=3306 MYSQL_DATABASE=node_mysql_test MYSQL_USER=root MYSQL_PASSWORD= FILTER=integration npm test
```
